...
class Client:
    ...
    def gui_loop(self):
        self.win = tkinter.Tk()
        self.win.configure(bg="limegreen")
        self.chat_label = tkinter.Label(self.win, text="chat:", bg="lightgreen")
        ...
        self.text_label = tkinter.Label(self.win, text="Message", bg="lightgreen")
